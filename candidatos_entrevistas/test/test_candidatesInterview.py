...
class TestCandidateInterview(TestCase):
    ...
    def setUp(self):
        ...
        self.lista = ["INDIVIDUAL SP", "GRUPAL", "JEFE"]
        self.new_candidateinterview = {
            "idcandidate": self.data_factory.random_int(10, 50),
            "idinterview": self.lista[self.data_factory.random_int(0, 2)],
            "summonsdate": self.data_factory.date(),
            "interviewer" : self.data_factory.name()
        }
        print(self.new_candidateinterview)
    ...
    def test_create_candidate_400_duplicate_request(self):
        ...
        new_candidateinterview = {
            "idcandidate": self.data_factory.random_int(100, 200),
    ...
    def test_create_candidate_400_invalid_request(self):
        lista = ["INDIVIDUAL SP", "GRUPAL", "JEFE"]
        new_candidateinterview = {
            "idcandidate": self.data_factory.random_int(1, 10),
            "idinterview": lista[self.data_factory.random_int(0, 2)],
            "summonsdate": self.data_factory.date(),
            "interviewer" : self.data_factory.name()
        }

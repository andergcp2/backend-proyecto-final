...
from vistas import VistaPing, VistaRecordScore
...
api = Api(app)
api.add_resource(VistaRecordScore, '/recordscore/<int:idcandidatetest>')
api.add_resource(VistaPing, '/recordscore/ping')

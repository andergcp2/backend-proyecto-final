...
api.add_resource(PruebaInit, '/tests-taker/init/<string:candidatoId>/<string:pruebaId>')
api.add_resource(PruebaNext, '/tests-taker/next/<string:candidatoId>/<string:pruebaId>')
api.add_resource(PruebaDone, '/tests-taker/done/<string:candidatoId>/<string:pruebaId>')

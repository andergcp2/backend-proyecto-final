...
from vistas import VistaPing, VistaCandidate, VistaSearch
...
api = Api(app)
#api.add_resource(VistaCandidate, '/candidates')
api.add_resource(VistaPing, '/candidatessearch/ping')
api.add_resource(VistaSearch, '/candidatessearch')

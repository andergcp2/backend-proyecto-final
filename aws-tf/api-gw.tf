...
#   security_group_ids = [module.public_alb_security_group.security_group_id]
...
#   integration_uri  = module.public_alb.aws_alb_listener["HTTP"].arn
...
# }
#                    aws_apigatewayv2_api.apigw_http_endpoint, aws_lb_listener.ecs_alb_listener]
